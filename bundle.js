...
/***/ function(module, exports, __webpack_require__) {
	...
	var _containersApp = __webpack_require__(160);

	var _containersApp2 = _interopRequireDefault(_containersApp);

	var _containersConfig = __webpack_require__(260);

	var _containersConfig2 = _interopRequireDefault(_containersConfig);

	var _containersNoMatch = __webpack_require__(261);

	var _containersNoMatch2 = _interopRequireDefault(_containersNoMatch);
	...
	(0, _reactDom.render)(_react2['default'].createElement(
	  ...
	  _react2['default'].createElement(_reactRouter.Route, { path: '*', component: _containersApp2['default'] }),
	  _react2['default'].createElement(_reactRouter.Route, { path: '/config', component: _containersConfig2['default'] })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stylesheetsStyleCss = __webpack_require__(196);

	var _stylesheetsStyleCss2 = _interopRequireDefault(_stylesheetsStyleCss);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.todo = _interopRequire(_todos);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _constantsTicketTypes = __webpack_require__(195);

	var types = _interopRequireWildcard(_constantsTicketTypes);

	var initialState = {
	  status: 'IDLE',
	  todos: [],
	  applicationKey: window.applicationKey,
	  token: window.token || '9095dce01c6f3cc3e52fe81c7592a74aa4992ada1cfed5bf9ac3090acdd4552c',
	  board_id: window.boardId || '5bbd19ae3a34400a0a0de592',
	  list_id: window.listId || '5bbd19be97965a698a2d3585',
	  done_list_id: window.doneListId || '5bbd19c00025a18addb0514f'
	};
...
/***/ function(module, exports) {
	...
	var UPDATE_TICKET_PENDING = "UPDATE_TICKET_PENDING";
	exports.UPDATE_TICKET_PENDING = UPDATE_TICKET_PENDING;
	var GET_TICKETS_PENDING = "GET_TICKETS_PENDING";
	exports.GET_TICKETS_PENDING = GET_TICKETS_PENDING;
	var ADD_TICKET_PENDING = "ADD_TICKET_PENDING";
	exports.ADD_TICKET_PENDING = ADD_TICKET_PENDING;
	var AUTHENTICATE_PENDING = "AUTHENTICATE_PENDING";
	exports.AUTHENTICATE_PENDING = AUTHENTICATE_PENDING;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/* Base */\n* { box-sizing: border-box; margin: 0; padding: 0; }\nhtml { font-size: 10px; }\nbody { font-family: \"Roboto\", Helvetica, Arial; font-size: 1.4rem; background-color: #cddc39; }\nsection { width: 600px; margin: 0 auto; }\n\n.o-ticket-list {\n  margin-top: 30vh;\n}\n\n.m-ticket {\n  overflow: auto;\n  margin: 4px 0;\n  height: 60px;\n  position: relative;\n}\n\n.m-ticket .a-ticket-name {\n\tdisplay: inline-block;\n\tposition: relative;\n\tfont-size: 2em;\n\tpadding: 0 0 0 80px;\n  margin-top: 4px;\n\tvertical-align: top;\n\tcolor: rgba(0,0,0,0.5);\n\tcursor: pointer;\n\ttransition: color 0.3s;\n}\n\n.m-ticket .a-ticket-checkbox,\n.m-ticket .a-ticket-name::before {\n\twidth: 42px;\n\theight: 42px;\n\ttop: 50%;\n\tleft: 0;\n\tmargin-top: -21px;\n\tposition: absolute;\n\tcursor: pointer;\n}\n\n.m-ticket .a-ticket-checkbox {\n\topacity: 0;\n\tdisplay: inline-block;\n\tvertical-align: middle;\n\tz-index: 100;\n}\n\n.m-ticket .a-ticket-name::before {\n\tcontent: '';\n\tborder: 4px solid #eee;\n\ttransition: opacity 0.3s;\n}\n\n.m-ticket:focus {\n  background-color: pink;\n}\n\n.a-ticket-link {\n  color: #fff;\n}\n\nli.placeholder {background: rgb(255,240,120);}\nli.placeholder:before {\n  content: \"Drop here\";\n  color: rgb(225,210,90);\n}\n\n/* State classes */\n\n.m-ticket.is-checked .a-ticket-name,\n.a-ticket-checkbox:checked + .a-ticket-name {\ncolor: #fff;\n  text-decoration: line-through;\n}\n\n.m-ticket.is-checked .a-ticket-name::before,\n.a-ticket-checkbox:checked + .a-ticket-name::before {\n  background-color: white;\n}\n\n.a-ticket-checkbox:focus + .a-ticket-name::before,\n.m-ticket:hover .a-ticket-name::before {\n  border: 4px solid #fff;\n}\n\n.m-ticket:hover .a-ticket-name,\n.a-ticket-checkbox:focus + .a-ticket-name {\n  color: #3a3a3a;\n}\n\n.a-ticket-link:focus, .a-ticket-link:hover {\n  outline: none;\n  color: #3a3a3a;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsTicketActions = __webpack_require__(255);

	var action = _interopRequireWildcard(_actionsTicketActions);

	var _componentsTicketList = __webpack_require__(258);

	var _componentsTicketList2 = _interopRequireDefault(_componentsTicketList);

	var TodoApp = (function (_Component) {
	  _inherits(TodoApp, _Component);

	  function TodoApp() {
	    _classCallCheck(this, _TodoApp);

	    _get(Object.getPrototypeOf(_TodoApp.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(TodoApp, [{
	    key: 'componentWillMount',
	    value: function componentWillMount() {
	      action.getTickets(this.props.dispatch, this.props.list_id, this.props.applicationKey, this.props.token);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'section',
	        null,
	        _react2['default'].createElement(_componentsTicketList2['default'], {
	          onCheck: action.check(this.props.dispatch, this.props.list_id, this.props.done_list_id, this.props.applicationKey, this.props.token),
	          tickets: this.props.todos,
	    ...
	    value: {
	      ...
	      applicationKey: _react.PropTypes.string,
	      board_id: _react.PropTypes.string,
	      list_id: _react.PropTypes.string,
	      done_list_id: _react.PropTypes.string
	    },
	    enumerable: true
	  }]);

	  var _TodoApp = TodoApp;
	  TodoApp = (0, _reactRedux.connect)(function (state) {
	    return {
	      todos: state.todo.todos,
	      status: state.todo.status,
	      token: state.todo.token,
	      applicationKey: state.todo.applicationKey,
	      list_id: state.todo.list_id,
	      done_list_id: state.todo.done_list_id
	    };
	  })(TodoApp) || TodoApp;
	  return TodoApp;
	})(_react.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _apiTicketApi = __webpack_require__(256);

	var api = _interopRequireWildcard(_apiTicketApi);

	function authenticate(dispatch) {
	  dispatch({
	    type: types.AUTHENTICATE_PENDING
	  });
	...
	function check(dispatch, undone_list_id, done_list_id, application_key, token) {
	  return function (id, isChecked) {
	    dispatch({
	      type: types.UPDATE_TICKET_PENDING,
	      id: id,
	      isChecked: isChecked
	    });

	    var list_id = isChecked ? done_list_id : undone_list_id;
	    api.moveTicket(id, list_id, application_key, token, function (data) {
	      dispatch({
	...
	function getTickets(dispatch, list_id, application_key, token) {
	  dispatch({
	    type: types.GET_TICKETS_PENDING
	  });

	  api.getTickets(list_id, application_key, token, function (data) {
	    dispatch({
	...
	function addTicket(dispatch) {
	  dispatch({
	    type: types.ADD_TICKET_PENDING
	  });
	...
	function updateTicket(dispatch) {
	  dispatch({
	    type: types.UPDATE_TICKET_PENDING
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(fetch) {/* eslint-disable no-console */
	'use strict';
	...
	function addTicket(list_id, title, description, application_key, token, callback) {
	  ...
	  fetch(API_BASE + '/members/me/cards/?key=' + application_key + '&token=' + token, {
	    method: 'post',
	    headers: {
	  ...
	  }).then(getJson).then(callback)['catch'](logError);
	}
	...
	function moveTicket(card_id, list_id, application_key, token, callback) {
	  console.log('moveTicket');
	  fetch(API_BASE + '/cards/' + card_id + '/idList?key=' + application_key + '&token=' + token, {
	    method: 'put',
	    headers: {
	      Accept: 'application/json, text/plain, */*',
	      'Content-Type': 'application/json'
	...
	function getTickets(list_id, application_key, token, callback) {
	  console.log('getTickets');
	  fetch(API_BASE + '/lists/' + list_id + '/cards?key=' + application_key + '&token=' + token).then(getJson).then(callback)['catch'](logError);
	}

	function getLists(board_id, application_key, token, callback) {
	  console.log('getLists');

	  fetch(API_BASE + '/boards/' + board_id + '/lists?key=' + application_key + '&token=' + token).then(getJson).then(callback)['catch'](logError);
	}

	function getBoards(application_key, token, callback) {
	  console.log('updateTicket');

	  fetch(API_BASE + '/boards?key=' + application_key + '&token=' + token).then(getJson).then(callback)['catch'](logError);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Ticket = __webpack_require__(259);
	...
	var onDragStart = function onDragStart(e) {
	  undefined.dragged = e.currentTarget;
	...
	var onDragEnd = function onDragEnd(e) {
	  undefined.dragged.style.display = 'block';
	  undefined.dragged.parentNode.removeChild(placeholder);

	  // Update state
	  var data = undefined.state.data;
	  var from = Number(undefined.dragged.dataset.id);
	  var to = Number(undefined.over.dataset.id);
	  if (from < to) to--;
	  data.splice(to, 0, data.splice(from, 1)[0]);
	  undefined.setState({ data: data });
	};

	var onDragOver = function onDragOver(e) {
	  e.preventDefault();
	  undefined.dragged.style.display = 'none';
	  if (e.target.className == 'placeholder') return;
	  undefined.over = e.target;
	...
	exports["default"] = function (_ref) {
	  ...
	  return _react2["default"].createElement(
	    ...
	    _react2["default"].createElement("input", {
	      className: "a-ticket-checkbox",
	      type: "checkbox",
	      id: ticket.id,
	      defaultChecked: isChecked,
	      onClick: function (evt) {
	        return onCheck(evt.target.id, evt.target.checked);
	      }
	    }),
	    _react2["default"].createElement(
	      "label",
	      { htmlFor: ticket.id, className: "a-ticket-name" },
	      ticket.name
	    ),
	    _react2["default"].createElement(
	      "a",
	      { href: ticket.shortUrl, className: "a-ticket-link" },
